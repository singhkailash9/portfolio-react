...
function Icons() {
  return <div id="icons">
    ...
    <a href="mailto:singhkailash.sk9@gmail.com" target="_blank" rel="noopener noreferrer">
      <img src={process.env.PUBLIC_URL + "/icons/Gmail.png"} alt="gmail" className="icon"></img></a>
  </div>
}
